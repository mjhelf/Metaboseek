...
#' 
#' @param rawdata a (named) list of xcmsRaw objects, e.g. generated by Mseek::loadRawM, OR an MSnbase OnDiskMSnExp object 
...
#' 
#' @param rawdata a (named) list of xcmsRaw objects, e.g. generated by Mseek::loadRawM
