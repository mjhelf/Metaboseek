...
#' 
#' @param rawdata a (named) list of xcmsRaw objects, e.g. generated by METABOseek::loadRawM, OR an MSnbase OnDiskMSnExp object 
...
#' @param SN when calculating peak quality with quickshapes, reject any peaks with a signal-to-noise ratio than this (intensity range within observed rt window, MAX/ MEAN INTENSITY!)
#' 
#' @export
...
#' 
#' @param rawdata a (named) list of xcmsRaw objects, e.g. generated by METABOseek::loadRawM
