...
VennDiagramModule <- function(input,output, session, 
  ...
  Venn1 =  callModule(MultiFilterModule, "venn1", values = reactiveValues(featureTables = values$featureTables,
  ...
  Venn2 =  callModule(MultiFilterModule, "venn2", values = reactiveValues(featureTables = values$featureTables,
                                                                           MainTable = values$MainTable),
  ...
  Venn3 =  callModule(MultiFilterModule, "venn3", values = reactiveValues(featureTables = values$featureTables,
                                                                           MainTable = values$MainTable),
