...
#' @param groups named list of non-normalized intensity columns listed by group (as supplied by $anagroupnames of MseekFT objects), will be automatically renamed if useNormalized.
#' @param analyze character vector to select the analyses to be run: "Basic analysis", "clara_cluster", "t-test", "Peak shapes"
...
#' @param MSData a (named) list of xcmsRaw objects, e.g. generated by Mseek::loadRawM, OR an MSnbase OnDiskMSnExp object required for peak shape analysis
