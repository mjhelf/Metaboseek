...
The settings here are passed on the the SIRIUS executable. Please have a look at the SIRIUS documentation
to learn more about them.

* **Database:** Restrict SIRIUS analysis to a database ()
...
MS2 data can be analyzed with SIRIUS from inside the Metaboseek app. All settings for SIRIUS can be found in the [`Options box`](#OptionsBox). You first need to tell Metaboseek where the SIRIUS executable is located ("SIRIUS folder"). Metaboseek will generate a new folder there to store results from Sirius runs.
