...
The extracted intensities are used to calculate mean intensity across the unlabeled (S1) and unlabeled (S2) samples for both isotopologs.
...
carreid over from the original reference Feature Table.
