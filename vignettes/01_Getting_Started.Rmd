...
### JAVA {#javainfo}
Metaboseek version 0.9.3 requires java for full functionality. Make sure to install 32-bit Java  (the default version you get from java.com) if you are running 32-bit R, or 64-bit Java if you are running 64-bit R. [Get 64-bit Java from here](https://www.oracle.com/technetwork/java/javase/downloads/jre8-downloads-2133155.html). At the time of writing, this page is not only difficult to find, but also requires you to register to download..
